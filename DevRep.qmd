...
I now follow the authors in paraemtrizing the model using the experimental results:
...
T6 = pretty_table(t6, header = ["Roll-out", "Control", "Treatment", "All"], backend = Val(:html))
